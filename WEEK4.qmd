...
editor: visual
---
The learning diary of this week is about:

* SAR (the content of lecture)
* Policies in cities, and how we can use RS technology to achieve the goals/ideas behind the policy. And here we give an example in Pau da Lima, City of Salvador, Brazil.
